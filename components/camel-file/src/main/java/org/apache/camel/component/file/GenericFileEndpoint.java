...
public abstract class GenericFileEndpoint<T> extends ScheduledPollEndpoint implements BrowsableEndpoint {
    ...
    @UriParam(description = "This option is cccc to specify the encoding of the file. You can use this on the "
    ...
    /**
     * This option is cccc to specify the encoding of the file. You can use this on the consumer, to specify the
